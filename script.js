...
const projectData = {
    ...
    sniffer: {
        icon: "🕷️", title: "API Sniffer", badge: "STABLE", isLive: false,
    ...
    specter: {
        icon: "⚡", title: "Specter", badge: "BETA", isLive: false, hasDownload: true,
    ...
    infodisc: {
        icon: "🗄️", title: "InfoDisclosure", badge: "STABLE", isLive: false,
